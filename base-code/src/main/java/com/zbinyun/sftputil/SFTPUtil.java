...
//https://blog.csdn.net/hao134838/article/details/91619486
public class SFTPUtil {
    ...
    public static void main(String[] args) throws SftpException, IOException {
        SFTPUtil sftp = new SFTPUtil("mysftp", "12345678", "192.168.2.201", 22);
        sftp.login();
        File file = new File("D:\\test.txt");
        InputStream is = new FileInputStream(file);

        sftp.upload("/data/sftp/mysftp/upload", "test1.txt", is);
        sftp.logout();
    }
}
